...
namespace Model.MineSweeper
{
    internal class GameBoard : IGameBoard
    {
        ...
        public const double MinimalProbChange = 0.1;

        public const double MaximalProbChange = 0.9;
        ...
        public static GameBoard CreateRandom( int width, int height, int seed, double mineProbability )
        {
            ...
            else if ( mineProbability < MinimalProbChange || mineProbability > MaximalProbChange)
            {
